...
(custom-theme-set-faces
 'ScaleIO
 '(default ((t (:family "DejaVu Sans Mono" :foundry "unknown" :width normal :height 113 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "green" :background "black" :stipple nil :inherit nil))))
