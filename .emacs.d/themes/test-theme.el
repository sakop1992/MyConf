...
(custom-theme-set-faces
 'test
 '(default ((t (:inherit nil :stipple nil :background "black" :foreground "pale green" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "unknown" :family "DejaVu Sans Mono"))))
 ...
 '(secondary-selection ((t (:background "orange"))))
